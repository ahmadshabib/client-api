...
/**
 * Interface for the generic mapper between Json objects and Bom objects contains the common methods
 * to convert Json to Bom is extended for converting Bom to Json by specialized interface
 *
 * @author ahmad.shabib
 * @param <A> any object
 * @param <B> Bom object
